...
public class Afficher_CategorieController implements Initializable {
    ...
    private void Detail(ActionEvent event) throws IOException {
        ...
        String selected = s;
        Afficher_CategorieController e = new Afficher_CategorieController();
    ...
    private void Modifier(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../GUI/Ajouter_Categorie_1.fxml"));
            Parent root = loader.load();
            Ajouter_CategorieController cr = loader.getController();
            Service_Categorie_Event sc = new Service_Categorie_Event();
            ...
            Logger.getLogger(Afficher_CategorieController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
